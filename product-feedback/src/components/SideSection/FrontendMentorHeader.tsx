...
const FrontendMentorHeader: React.FC<FrontendMentorHeaderProps> = ({
  ...
  return (
    <div className="flex h-[72px] w-screen items-center justify-between bg-[url('src/assets/suggestions/mobile/background-header.png')] bg-cover px-[24px] py-[15px] md:h-[178px] md:w-[223px] md:items-end md:rounded-xl md:bg-[url('src/assets/suggestions/tablet/background-header.png')]">
