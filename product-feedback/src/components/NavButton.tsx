...
const NavButton: React.FC<NavButtonProps> = ({ to, bgColor, bgHoverColor }) => {
  ...
  return (
    <NavLink
      to={to}
      className={`flex cursor-pointer items-center gap-1 rounded-xl ${bgClasses[bgColor]} px-[24px] py-[12px] text-h4 text-bt-white_def transition-colors ${hoverClasses[bgHoverColor]}`}
    >
