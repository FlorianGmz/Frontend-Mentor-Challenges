...
const FrontendMentorHeader: React.FC<FrontendMentorHeaderProps> = ({
  ...
  return (
    <div className="flex h-[72px] w-screen items-center justify-between bg-[url('public/assets/suggestions/mobile/background-header.png')] bg-cover px-[24px] py-[15px] md:h-[178px] md:w-[223px] md:items-end md:rounded-xl md:bg-[url('public/assets/suggestions/tablet/background-header.png')] xl:h-[137px] xl:w-[255px] xl:bg-[url('public/assets/suggestions/desktop/background-header.png')] xl:p-[24px]">
